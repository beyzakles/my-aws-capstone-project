...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ci1w2fdompjx.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'beyzablog' # please enter your s3 bucket name
